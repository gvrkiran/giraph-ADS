...
public class FacilityLocationADSInputFormat extends TextVertexInputFormat<LongWritable, FacilityLocationADSVertexValue, FloatWritable> {
	...
	*/
	...
	private class FacilityLocationADSVertexReaderFromEachLine extends TextVertexReaderFromEachLine {
		...
		@Override
		protected FacilityLocationADSVertexValue getValue(Text line) throws IOException {
				FacilityLocationADSVertexValue value = new FacilityLocationADSVertexValue();
				String[] splitLine = line.toString().split("\t");
